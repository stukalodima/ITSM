...
alter table FINANCE_ISSUE_FILE add constraint FK_FINANCE_ISSUE_FILE_ON_AUTHOR foreign key (AUTHOR_ID) references SEC_USER(ID)^
...
create index IDX_FINANCE_ISSUE_FILE_ON_AUTHOR on FINANCE_ISSUE_FILE (AUTHOR_ID)^
...
alter table FINANCE_CONSULTATION_REQUEST add constraint FK_FINANCE_CONSULTATION_REQUEST_ON_ASSIGNED_TO foreign key (ASSIGNED_TO_ID) references SEC_USER(ID)^
alter table FINANCE_CONSULTATION_REQUEST add constraint FK_FINANCE_CONSULTATION_REQUEST_ON_ISSUE foreign key (ISSUE_ID) references FINANCE_ISSUE(ID)^
alter table FINANCE_CONSULTATION_REQUEST add constraint FK_FINANCE_CONSULTATION_REQUEST_ON_PROJECT foreign key (PROJECT_ID) references FINANCE_PROJECT(ID)^
alter table FINANCE_CONSULTATION_REQUEST add constraint FK_FINANCE_CONSULTATION_REQUEST_ON_ASSET foreign key (ASSET_ID) references FINANCE_ASSET(ID)^
...
create index IDX_FINANCE_CONSULTATION_REQUEST_ON_ASSIGNED_TO on FINANCE_CONSULTATION_REQUEST (ASSIGNED_TO_ID)^
create index IDX_FINANCE_CONSULTATION_REQUEST_ON_ISSUE on FINANCE_CONSULTATION_REQUEST (ISSUE_ID)^
create index IDX_FINANCE_CONSULTATION_REQUEST_ON_PROJECT on FINANCE_CONSULTATION_REQUEST (PROJECT_ID)^
create index IDX_FINANCE_CONSULTATION_REQUEST_ON_ASSET on FINANCE_CONSULTATION_REQUEST (ASSET_ID)^
...
alter table FINANCE_CONSULTATION_REQUEST_FILE add constraint FK_FINANCE_CONSULTATION_REQUEST_FILE_ON_DOCUMENT foreign key (DOCUMENT_ID) references SYS_FILE(ID)^
alter table FINANCE_CONSULTATION_REQUEST_FILE add constraint FK_FINANCE_CONSULTATION_REQUEST_FILE_ON_CONSULTATION_REQUEST foreign key (CONSULTATION_REQUEST_ID) references FINANCE_CONSULTATION_REQUEST(ID)^
alter table FINANCE_CONSULTATION_REQUEST_FILE add constraint FK_FINANCE_CONSULTATION_REQUEST_FILE_ON_AUTHOR foreign key (AUTHOR_ID) references SEC_USER(ID)^
create index IDX_FINANCE_CONSULTATION_REQUEST_FILE_ON_DOCUMENT on FINANCE_CONSULTATION_REQUEST_FILE (DOCUMENT_ID)^
create index IDX_FINANCE_CONSULTATION_REQUEST_FILE_ON_CONSULTATION_REQUEST on FINANCE_CONSULTATION_REQUEST_FILE (CONSULTATION_REQUEST_ID)^
create index IDX_FINANCE_CONSULTATION_REQUEST_FILE_ON_AUTHOR on FINANCE_CONSULTATION_REQUEST_FILE (AUTHOR_ID)^
...
alter table FINANCE_FUTURE add constraint FK_FINANCE_FUTURE_ON_ISSUE foreign key (ISSUE_ID) references FINANCE_ISSUE(ID)^
alter table FINANCE_FUTURE add constraint FK_FINANCE_FUTURE_ON_COMPANY foreign key (COMPANY_ID) references FINANCE_COMPANY(ID)^
alter table FINANCE_FUTURE add constraint FK_FINANCE_FUTURE_ON_BUSINESS foreign key (BUSINESS_ID) references FINANCE_BUSINESS(ID)^
alter table FINANCE_FUTURE add constraint FK_FINANCE_FUTURE_ON_PROJECT foreign key (PROJECT_ID) references FINANCE_PROJECT(ID)^
alter table FINANCE_FUTURE add constraint FK_FINANCE_FUTURE_ON_ASSET foreign key (ASSET_ID) references FINANCE_ASSET(ID)^
alter table FINANCE_FUTURE add constraint FK_FINANCE_FUTURE_ON_STATUS foreign key (STATUS_ID) references FINANCE_STATUSES(ID)^
alter table FINANCE_FUTURE add constraint FK_FINANCE_FUTURE_ON_IMPLEMENTER foreign key (IMPLEMENTER_ID) references SEC_USER(ID)^
create index IDX_FINANCE_FUTURE_ON_ISSUE on FINANCE_FUTURE (ISSUE_ID)^
create index IDX_FINANCE_FUTURE_ON_COMPANY on FINANCE_FUTURE (COMPANY_ID)^
create index IDX_FINANCE_FUTURE_ON_BUSINESS on FINANCE_FUTURE (BUSINESS_ID)^
create index IDX_FINANCE_FUTURE_ON_PROJECT on FINANCE_FUTURE (PROJECT_ID)^
create index IDX_FINANCE_FUTURE_ON_ASSET on FINANCE_FUTURE (ASSET_ID)^
create index IDX_FINANCE_FUTURE_ON_STATUS on FINANCE_FUTURE (STATUS_ID)^
create index IDX_FINANCE_FUTURE_ON_IMPLEMENTER on FINANCE_FUTURE (IMPLEMENTER_ID)^
-- end FINANCE_FUTURE
-- begin FINANCE_FUTURE_FILE
alter table FINANCE_FUTURE_FILE add constraint FK_FINANCE_FUTURE_FILE_ON_DOCUMENT foreign key (DOCUMENT_ID) references SYS_FILE(ID)^
alter table FINANCE_FUTURE_FILE add constraint FK_FINANCE_FUTURE_FILE_ON_AUTHOR foreign key (AUTHOR_ID) references SEC_USER(ID)^
alter table FINANCE_FUTURE_FILE add constraint FK_FINANCE_FUTURE_FILE_ON_FUTURE foreign key (FUTURE_ID) references FINANCE_FUTURE(ID)^
create index IDX_FINANCE_FUTURE_FILE_ON_DOCUMENT on FINANCE_FUTURE_FILE (DOCUMENT_ID)^
create index IDX_FINANCE_FUTURE_FILE_ON_AUTHOR on FINANCE_FUTURE_FILE (AUTHOR_ID)^
create index IDX_FINANCE_FUTURE_FILE_ON_FUTURE on FINANCE_FUTURE_FILE (FUTURE_ID)^
